...
<div class="cover">
  ...
  <div id="madeby">
    <span>
      Try - https://mans-media.herokuapp.com/websites/mediafire.com/direct_download.php?id=<b>YOUR_FILE_ID</b>
    </span>
  </div>
</div>
...
function grab() {
 let i = 'https://mans-media.herokuapp.com/websites/mediafire.com/direct_download.php?id='+document.getElementById('url').value.split("/")[4]+'';
